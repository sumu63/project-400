<!--banner-slider-->
  ...
  <section class="w3l-main-slider" id="home">
    <div class="banner-content">
      <div id="demo-1"
        data-zs-src='["<?php echo base_url();?>/assets/images/banner1.jpg", "<?php echo base_url();?>/assets/images/banner2.jpg","<?php echo base_url();?>/assets/images/banner3.jpg", "<?php echo base_url();?>/assets/images/banner4.jpg"]'
            ...
            <div class="maghny-gd-1 col-lg-6">
              <div class="maghny-grid">
                <figure class="effect-lily border-radius  m-0">
                    <img class="img-fluid" src="<?php echo base_url();?>/assets/images/g10.jpg" alt="" />
                    <figcaption>
                        <div>
            ...
            <div class="maghny-gd-1 col-lg-6 mt-lg-0 mt-4">
                <div class="row">
                    <div class="maghny-gd-1 col-6">
                        <div class="maghny-grid">
                            <figure class="effect-lily border-radius">
                                <img class="img-fluid" src="<?php echo base_url();?>/assets/images/g9.jpg" alt="" />
                                <figcaption>
                                    <div>
                                        <h4>3Days, 4 Nights</h4>
                                        <p>From 1220$ </p>
                    ...
                    <div class="maghny-gd-1 col-6">
                        <div class="maghny-grid">
                            <figure class="effect-lily border-radius">
                                <img class="img-fluid" src="<?php echo base_url();?>/assets/images/g8.jpg" alt="" />
                                <figcaption>
                                    <div>
                                        <h4>3Days, 4 Nights</h4>
                                        <p>From 1620$ </p>
                    ...
                    <div class="maghny-gd-1 col-6 mt-4">
                        <div class="maghny-grid">
                            <figure class="effect-lily border-radius">
                                <img class="img-fluid" src="<?php echo base_url();?>/assets/images/g7.jpg" alt="" />
                                <figcaption>
                                    <div>
                                        <h4>3Days, 4 Nights</h4>
                                        <p>From 1820$ </p>
                    ...
                    <div class="maghny-gd-1 col-6 mt-4">
                        <div class="maghny-grid">
                            <figure class="effect-lily border-radius">
                                <img class="img-fluid" src="<?php echo base_url();?>/assets/images/g6.jpg" alt="" />
                                <figcaption>
                                    <div>
                                        <h4>3Days, 4 Nights</h4>
                                        <p>From 1520$ </p>
            ...
            <div class="item">
              <div class="testimonial-content">
                <div class="testimonial">
                  ...
                  <div class="testi-des">
                    <div class="test-img"><img src="<?php echo base_url();?>/assets/images/c1.jpg" class="img-fluid" alt="client-img">
                    </div>
            ...
            <div class="item">
              <div class="testimonial-content">
                <div class="testimonial">
                  ...
                  <div class="testi-des">
                    <div class="test-img"><img src="<?php echo base_url();?>/assets/images/c2.jpg" class="img-fluid" alt="client-img">
                    </div>
                    <div class="peopl align-self">
                      <h3>Shveta</h3>
                      <p class="indentity">Example City</p>
            ...
            <div class="item">
              <div class="testimonial-content">
                <div class="testimonial">
                  ...
                  <div class="testi-des">
                    <div class="test-img"><img src="<?php echo base_url();?>/assets/images/c3.jpg" class="img-fluid" alt="client-img">
                    </div>
                    <div class="peopl align-self">
                      <h3>Roy Linderson</h3>
                      <p class="indentity">Example City</p>
            ...
            <div class="item">
              <div class="testimonial-content">
                <div class="testimonial">
                  ...
                  <div class="testi-des">
                    <div class="test-img"><img src="<?php echo base_url();?>/assets/images/c4.jpg" class="img-fluid" alt="client-img">
                    </div>
                    <div class="peopl align-self">
                      <h3>Mike Thyson</h3>
                      <p class="indentity">Example City</p>
