      ...
      <div class="container py-lg-5">
        ...
        <div class="row mt-5">
          <div class="col-md-9 mx-auto">
            <img src="<?php echo base_url();?>/assets/images/banner3.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 content-6-right mt-lg-0 mt-4">
          <p class="mb-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum labore sed, veniam nisi sunt laboriosam ducimus, odio
            ...
            <p class="mb-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum labore sed, veniam nisi sunt laboriosam ducimus, odio
              aspernatur fugiat minima blanditiis dignissimos.</p>
              <a href="<?php echo base_url();?>about_us.php" class="btn btn-style btn-primary mt-4">Read More</a>
        </div>
      </div>
    </div>
</section>
    ...
    <div class="container py-lg-5">
      <div class="row">
        <div class="col-md-4 col-sm-6 mt-0 grids5-info">
          <a href="#url"><img src="<?php echo base_url();?>/assets/images/g1.jpg" class="img-fluid" alt=""></a>
          <h5>Lorem</h5>
        ...
        <div class="col-md-4 col-sm-6 mt-sm-0 mt-5 grids5-info">
          <a href="#url"><img src="<?php echo base_url();?>/assets/images/g2.jpg" class="img-fluid" alt=""></a>
          <h5>Lorem</h5>
          <h4><a href="#url"> 
        ...
        <div class="col-md-4 col-sm-6 mt-md-0 mt-5 grids5-info">
          <a href="#url"><img src="<?php echo base_url();?>/assets/images/g3.jpg" class="img-fluid" alt=""></a>
          <h5>Lorem</h5>
      ...
      <div class="container py-lg-5">
        ...
        <div class="row">
          <div class="col-lg-3 col-6 mt-lg-5 mt-4">
            <div class="box16">
              <a href="#url"><img src="<?php echo base_url();?>/assets/images/team1.jpg" alt="" class="img-fluid" /></a>
          ...
          <div class="col-lg-3 col-6 mt-lg-5 mt-4">
            <div class="box16">
              <a href="#url"><img src="<?php echo base_url();?>/assets/images/team2.jpg" alt="" class="img-fluid" /></a>
              <div class="box-content">
          ...
          <div class="col-lg-3 col-6 mt-lg-5 mt-4">
            <div class="box16">
              <a href="#url"><img src="<?php echo base_url();?>/assets/images/team3.jpg" alt="" class="img-fluid" /></a>
              <div class="box-content">
          ...
          <div class="col-lg-3 col-6 mt-lg-5 mt-4">
            <div class="box16">
              <a href="#url"><img src="<?php echo base_url();?>/assets/images/team4.jpg" alt="" class="img-fluid" /></a>
              <div class="box-content">
