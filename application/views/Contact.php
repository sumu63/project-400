          ...
          <form action="" method="post" class="signin-form">
            <div class="input-grids">
              <div class="form-group">
                <input value="" type="text" name="userame" id="username" placeholder="Username" class="contact-input"/>
            ...
            <div class="form-group">
              <textarea name="comment" id="message" placeholder="Type your message here*" required=""></textarea>
            </div>
